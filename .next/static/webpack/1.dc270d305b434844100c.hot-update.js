...
function (_Component) {
  ...
  function AirlineDashboardLayout() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateGraph", function () {
      var data = {
        type: 'bar',
        x: _this.state.defaultGraphX,
        y: _this.state.defaultGraphY
      };
      return data;
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "filterDefaultGraph", function (airline, status) {
      ...
      if (status === 'Pax') {
        ...
        for (var i = 0; i < _this.state.y2017.data.length; i++) {
          if (_this.state.y2017.data[i].OWNER_CODE === airline) {
            pax = pax + _this.state.y2017.data[i].PAX_TOTAL;
          }

          _this.state.pax[4] = pax;
          _this.state.defaultGraphY[4] = pax;
          _this.state.defaultGraph[4].y = pax;
        }
      }
      ...
      if (status === 'Seat') {
        ...
        for (var _i2 = 0; _i2 < _this.state.y2017.data.length; _i2++) {
          if (_this.state.y2017.data[_i2].OWNER_CODE === airline) {
            seat = seat + _this.state.y2017.data[_i2].SEATS;
          }
...
//# sourceMappingURL=1.dc270d305b434844100c.hot-update.js.map